...
The governed API is the durable source of truth for career and application plans. Recommendations never predict hiring outcomes or use protected traits. Candidates can request explanation, appeal, correction, export, or erasure; a qualified human reviews consequential guidance. Generated backlog endpoints are disabled by default and cannot be enabled in production.
